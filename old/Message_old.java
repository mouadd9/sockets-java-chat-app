...
public class Message_old {
    ...
    public Message_old(final String senderEmail, final String receiverEmail, final String content) {
        this();
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof Message_old))
            return false;
        Message_old message = (Message_old) o;
